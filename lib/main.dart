...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void _startCountdown() {
    ...
    _secondsSinceEpoch = DateTime.now()
        .add(Duration(minutes: _countdownTime))
  ...
  void updateCountdown() {
    try {
      database
        ..where('name', isEqualTo: '1').getDocuments().then((value) {
  ...
  void _doCountdown(var length) {
    ...
    sub.onData((duration) {
      setState(() {
        ...
        String seconds =
            (duration.remaining.inSeconds % 60).toString().padLeft(2, '0');
        ...
        child: new Column(
          ...
          children: <Widget>[
            StreamBuilder(
              ...
              builder: (context, snapshot) {
                if (snapshot.hasData &&
                  ...
                  if (_state == false) {
                    // TODO # Bodge it ftw
                    Map data = snapshot.data.documents.removeLast();
            ...
            Padding(
                ...
                child: TextField(
                    onSubmitted: (value) {
                      _changeCountdown(int.parse(value));
                    },
            ...
            StreamBuilder(
              ...
              builder: (context, snapshot) {
                if (snapshot.hasData &&
                  ...
                  String endTime =
                      DateTime.fromMillisecondsSinceEpoch(_secondsSinceEpoch)
                          .toString();
                  return Padding(
                      ...
                      child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Text("time: $_countdownTime",
                                style: TextStyle(fontSize: 16)),
                            Text("epoch: $_secondsSinceEpoch",
                                style: TextStyle(fontSize: 16)),
                            Text("time stamp: $endTime",
                                style: TextStyle(fontSize: 16))
                          ]));
                } else
